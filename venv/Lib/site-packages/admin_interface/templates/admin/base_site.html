...
{% endif %}
    ...
    <link rel = "icon" href ="https://i.ibb.co/cwLqrN7/Webp-net-resizeimage.png"
        type = "image/x-icon">
...
<h1 id="site-name">
    {% if theme.logo_visible %}
        {% if theme.logo %}
        <img class="logo" style="display:none;" src="https://i.ibb.co/cwLqrN7/Webp-net-resizeimage.png" {% if theme.logo.width %}width="{{ theme.logo.width }}"{% endif %} {% if theme.logo.height %}height="{{ theme.logo.height }}"{% endif %}>
        {% else %}
        <img class="logo default" style="display:none;" src="https://i.ibb.co/cwLqrN7/Webp-net-resizeimage.png" width="75" height="75">
        {% endif %}
    {% endif %}
